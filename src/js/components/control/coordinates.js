...
proj4.defs("EPSG:26786", "+proj=lcc +lat_0=41 +lon_0=-71.5 +lat_1=41.7166666666667 +lat_2=42.6833333333333 +x_0=55725.5531794 +y_0=0 +datum=NAD27 +ellps=clrk66 +units=m +no_defs");
proj4.defs("EPSG:26787", "+proj=lcc +lat_0=41 +lon_0=-70.5 +lat_1=41.2833333333333 +lat_2=41.4833333333333 +x_0=18571.8132563 +y_0=0 +datum=NAD27 +ellps=clrk66 +units=m +no_defs");
...
function renderPointsList(){
    ...
    // Loop through points
// In renderPointsList(), update coordDisplay to use EPSG conversion
collectedPoints.forEach((p,index)=>{
    ...
    html += `
        <div class="coord-row">
            ...
            <div class="coord-values" style="width:120px;">
